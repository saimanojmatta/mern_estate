...
import { FaShare,FaBath,FaBed,FaParking,FaChair,FaMapMarkedAlt } from "react-icons/fa";
        ...
        {listing && !loading && !error && (
            <div>
               ...
               <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
                ...
                <p className="flex items-center mt-6 gap-3 text-slate-600 text-sm ">
